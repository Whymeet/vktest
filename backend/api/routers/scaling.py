...
async def get_scaling_configs_endpoint(
    ...
    for config in configs:
        ...
        result.append({
            ...
            "new_banner_name_template": getattr(config, 'new_banner_name_template', None),
...
async def create_scaling_config_endpoint(
    ...
    try:
        config = crud.create_scaling_config(
            ...
            new_banner_name_template=data.new_banner_name_template,
...
async def run_scaling_config(
    ...
    accounts_data = [(acc.id, acc.name, acc.api_token, acc.label, acc.leadstech_enabled) for acc in accounts]
